...
AppModule.ɵinj = /*@__PURE__*/ i0.ɵɵdefineInjector({ providers: [{ provide: RouteReuseStrategy, useClass: IonicRouteStrategy }], imports: [BrowserModule, IonicModule.forRoot(), AppRoutingModule, IdVisionComponent, HttpClientModule, IonicStorageModule.forRoot() // Agrega esta línea
    ] });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(AppModule, { declarations: [AppComponent, CustomButtonComponent, CameraWithOverlayComponent, CamaraVideoSelfieComponent], imports: [BrowserModule, i1.IonicModule, AppRoutingModule, IdVisionComponent, HttpClientModule, i2.IonicStorageModule] }); })();
