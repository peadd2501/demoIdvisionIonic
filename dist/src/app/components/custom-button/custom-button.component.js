...
export class CustomButtonComponent {
    ...
    static { this.ɵfac = function CustomButtonComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || CustomButtonComponent)(); }; }
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CustomButtonComponent, selectors: [["app-custom-button"]], inputs: { texto: "texto", disabled: "disabled", icon: "icon", showIcon: "showIcon" }, outputs: { clicked: "clicked" }, decls: 3, vars: 3, consts: [["expand", "block", 3, "click", "disabled"], ["slot", "start", 3, "name", 4, "ngIf"], ["slot", "start", 3, "name"]], template: function CustomButtonComponent_Template(rf, ctx) { if (rf & 1) {
