...
export class PhotoSelfieComponent {
    static { this.ɵfac = function PhotoSelfieComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || PhotoSelfieComponent)(); }; }
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PhotoSelfieComponent, selectors: [["app-photo-selfie"]], inputs: { openCamera: "openCamera" }, standalone: true, features: [i0.ɵɵStandaloneFeature], decls: 24, vars: 0, consts: [[1, "content"], [1, "head"], [1, "p-justify"], [1, "verify-container"], [1, "image-container"], ["src", "assets/imagesIdvision/Foco.png", "alt", ""], [1, "container-text"], ["src", "assets/imagesIdvision/rostroImage.png", "alt", ""], [1, "fixed-footer"], ["expand", "block", 1, "custom-button", 3, "click"]], template: function PhotoSelfieComponent_Template(rf, ctx) { if (rf & 1) {
