...
export class IdVisionComponent {
    constructor(modalController, dpiService, alertController, loadingController, platform, modalDpiServices, modalVideoSelfieServices, sdkCommunicationService, navController) {
...
IdVisionComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: IdVisionComponent, selectors: [["app-id-vision"]], viewQuery: function IdVisionComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        i0.ɵɵlistener("click", function IdVisionComponent_Template_ion_button_click_96_listener() { i0.ɵɵrestoreView(_r1); return i0.ɵɵresetView(ctx.handleGetInit()); });
        i0.ɵɵtext(97, "Salir");
        i0.ɵɵelementEnd()()()()()();
    } if (rf & 2) {
        i0.ɵɵadvance(92);
