...
export declare class ModalVideoSelfieServices {
    private closeOverlaySubjectModal;
    closeOverlayModal$: import("rxjs").Observable<void>;
    requestCloseOverlayModal(): void;
