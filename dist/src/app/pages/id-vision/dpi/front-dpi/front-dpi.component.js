...
export class FrontDpiComponent {
    ...
    static { this.ɵfac = function FrontDpiComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || FrontDpiComponent)(i0.ɵɵdirectiveInject(i1.AlertController), i0.ɵɵdirectiveInject(i1.LoadingController), i0.ɵɵdirectiveInject(i1.ModalController)); }; }
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: FrontDpiComponent, selectors: [["app-front-dpi"]], decls: 2, vars: 0, template: function FrontDpiComponent_Template(rf, ctx) { if (rf & 1) {
