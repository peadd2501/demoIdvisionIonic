...
export class CamaraAcuerdoVideoComponent {
    ...
    static { this.ɵfac = function CamaraAcuerdoVideoComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || CamaraAcuerdoVideoComponent)(i0.ɵɵdirectiveInject(i1.Platform), i0.ɵɵdirectiveInject(i0.ChangeDetectorRef), i0.ɵɵdirectiveInject(i2.ModalDpiServices), i0.ɵɵdirectiveInject(i1.ModalController)); }; }
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CamaraAcuerdoVideoComponent, selectors: [["app-acuerdo-video"]], viewQuery: function CamaraAcuerdoVideoComponent_Query(rf, ctx) { if (rf & 1) {
