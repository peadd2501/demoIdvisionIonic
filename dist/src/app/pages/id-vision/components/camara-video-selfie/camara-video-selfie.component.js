...
export class CamaraVideoSelfieComponent {
    constructor(platform, modalController, sanitizer, renderer, alertController, changeDetector, modalVideoSelfieServices) {
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(CamaraVideoSelfieComponent, [{
    ...
    }], () => [{ type: i1.Platform }, { type: i1.ModalController }, { type: i2.DomSanitizer }, { type: i0.Renderer2 }, { type: i1.AlertController }, { type: i0.ChangeDetectorRef }, { type: i3.ModalVideoSelfieServices }], { videoElement: [{
            type: ViewChild,
            args: ['videoElement']
        }], progressRing: [{
            type: ViewChild,
