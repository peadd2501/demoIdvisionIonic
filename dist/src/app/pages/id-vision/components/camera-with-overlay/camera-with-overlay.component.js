...
function CameraWithOverlayComponent_div_18_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(3);
    i0.ɵɵproperty("src", ctx_r1.capturedImageUrl, i0.ɵɵsanitizeUrl);
} }
...
CameraWithOverlayComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CameraWithOverlayComponent, selectors: [["app-camera-overlay"]], viewQuery: function CameraWithOverlayComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { text1: "text1", text2: "text2", overlaySrc: "overlaySrc", onTakePicture: "onTakePicture" }, outputs: { closeRequested: "closeRequested" }, decls: 19, vars: 4, consts: [["videoElement", ""], ["color", "dark"], [1, "camera-overlay"], [1, "header-text"], [1, "text-help"], [1, "country"], ["class", "loading-overlay", 4, "ngIf"], [1, "visible-window"], [1, "camera-container"], ["autoplay", "", "muted", "", "playsinline", ""], [1, "button-container"], ["shape", "round", "expand", "block", 1, "capture-button", 3, "click"], ["name", "camera-outline"], ["fill", "clear", 1, "close-button", 3, "click"], ["name", "close-outline"], [4, "ngIf"], [1, "loading-overlay"], ["name", "crescent"], ["alt", "Foto capturada", 3, "src"]], template: function CameraWithOverlayComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        i0.ɵɵelementEnd()();
        i0.ɵɵtemplate(18, CameraWithOverlayComponent_div_18_Template, 4, 1, "div", 15);
        i0.ɵɵelementEnd();
    } if (rf & 2) {
        i0.ɵɵadvance(5);
