...
MessageModalComponent.ɵfac = function MessageModalComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || MessageModalComponent)(i0.ɵɵdirectiveInject(i1.ModalController)); };
MessageModalComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: MessageModalComponent, selectors: [["app-modal-error"]], inputs: { title: "title", variant: "variant", message: "message", errors: "errors" }, decls: 13, vars: 6, consts: [["singleMessage", ""], [1, "custom-modal-content"], [1, "modal-wrapper"], [3, "ngSwitch"], [4, "ngSwitchCase"], [4, "ngSwitchDefault"], [1, "modal-title"], [4, "ngIf", "ngIfElse"], ["expand", "block", 1, "modal-button", 3, "click"], ["src", "assets/icons/dpi-error.svg", "alt", "Icono DPI", 1, "modal-icon"], ["src", "assets/icons/video-error.svg", "alt", "Icono Video", 1, "modal-icon"], [1, "error-list"], [4, "ngFor", "ngForOf"], [1, "modal-message"]], template: function MessageModalComponent_Template(rf, ctx) { if (rf & 1) {
