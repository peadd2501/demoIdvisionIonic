...
export class HomePage {
    constructor() { }
    static { this.ɵfac = function HomePage_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || HomePage)(); }; }
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: HomePage, selectors: [["app-home"]], decls: 16, vars: 2, consts: [[3, "translucent"], [3, "fullscreen"], ["collapse", "condense"], ["size", "large"], ["id", "container"], ["target", "_blank", "rel", "noopener noreferrer", "href", "https://ionicframework.com/docs/components"]], template: function HomePage_Template(rf, ctx) { if (rf & 1) {
